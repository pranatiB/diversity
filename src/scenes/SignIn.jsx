...
export default function SignIn() {
  ...
  const handleSubmit = (event) => {
    ...
    if (userType === 'admin' && password === adminPassword) {
      ...
      alert('Authentication failed. Please check your userType and password.');
    }
  };
...
// import { auth, db } from './src'; // Import the auth and db objects from your firebase.js file
...
//       const userCredential = await auth.createUserWithEmailAndPassword(`${userType}@example.com`, password);
